...
import { ShieldQuestion, Save, User, Mail, Lock, Eye, EyeOff } from "lucide-react";
        ...
        <main style={{ flex: 1, padding: "32px", overflowY: "auto" }}>
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="gov-card" style={{ padding: 24, height: "100%", display: "flex", flexDirection: "column" }}>
              <h2 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 20, color: "white" }}>Profile</h2>

              <div style={{ marginBottom: 16 }}>
                <label className="form-label" style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                  <User size={14} style={{ color: "var(--color-gov-gold)" }} />
                  Name
                </label>
                <input
              ...
              <div style={{ marginBottom: 16 }}>
                <label className="form-label" style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                  <Mail size={14} style={{ color: "var(--color-gov-gold)" }} />
                  Email
                </label>
                <input
                  className="form-input"
